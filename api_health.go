...
func (r ApiGetHealthRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *HealthAPIService) GetHealthExecute(r ApiGetHealthRequest) (map[string]interface{}, *http.Response, error) {
	var (

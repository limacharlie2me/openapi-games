...
func (r ApiGetMetadataRequest) Execute() (*MetadataResponse, *http.Response, error) {
...
*/
func (a *MetadataAPIService) GetMetadata(ctx context.Context) ApiGetMetadataRequest {
	return ApiGetMetadataRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MetadataAPIService) GetMetadataExecute(r ApiGetMetadataRequest) (*MetadataResponse, *http.Response, error) {
	var (
